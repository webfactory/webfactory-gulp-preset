...
webfactory-gulp-preset geht davon aus, dass das `gulpfile.js` und eine `gulp-config.js` im Root-Verzeichnis des
Projektes liegen. 

## Demo für Gulpfile (`gulpfile.js`)
...
## Demo für Projekt-Config (`gulp-config.js`)
```js
